...
# - Incluiremos no tuning os parâmetros "padrões" do modelo, se não pode ser que só encontre resultados piores
...
n_estimators = range(10,251,30) #100
max_features = list(range(2, 11, 2)) #"auto"
max_features.append('auto')
min_samples_split = range(2, 11, 2)  #2
...
# - Para isso, temos que pegar o último Trimestre (que não usamos para treinar o modelo nem testar) e ver como ele teria saído 
